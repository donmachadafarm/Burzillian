...
<div id="page-wrapper">
 ...
 <h1 class="page-header">Raw Material Forecast</h1>
   ...
   <form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" id ="table_select">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name = "table_select" class="form-control" style="width: 300px;">
                                              <option value="1" selected>Weekly Inventory Forecast</option>
                                              <option value="2">Monthly Inventory Forecast</option>
                                              <option value="3">Yearly Inventory Forecast</option>
                                              <option value="4">Seasonal Inventory Forecast</option>
                                            </select>
                                        </div>
