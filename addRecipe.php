 ...
 ?>
        ...
        <div id="page-wrapper">
            ...
            //     require 'Connect.php';
                ...
                if(!isset($message)){
                //require 'Connect.php';
                $query=mysqli_query($conn, "insert into recipe (recipeName, instruction, prodID) values ('{$rName}', '{$rInstruct}', '{$prodID}')");
                ...
                $query1 = mysqli_query($conn, "select * from recipe");
                ...
                while($row=mysqli_fetch_array($query1)){
                   // if($row['recipeName'] == $rName){
                        ...
                        foreach($nVal as $index => $val){
                            ...
                            $query2 = mysqli_query($conn, "insert into recipeing (recipeID,ingID, measureID, measureVal, converted_measurement) values ('{$rRcp}','{$rCheck[$index]}', '{$nType[$index]}', '{$val}', '{$new_val}')");
                        }
